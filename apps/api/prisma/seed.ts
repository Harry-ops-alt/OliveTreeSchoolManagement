...
async function main() {
  ...
  const students: SeedStudent[] = [
    ...
    {
      email: "chioma.okafor@student.olive.school",
      firstName: "Chioma",
      lastName: "Okafor",
      ...
      primaryLanguage: "English",
      phone: "+2347010000006",
      dateOfBirth: new Date("2013-07-10T00:00:00.000Z"),
      ...
      guardians: [
        {
          id: "guardian-chioma-okafor",
          firstName: "Adaeze",
          lastName: "Okafor",
          email: "chioma.mum@example.com",
          phone: "+2347010000007",
      ...
      admission: {
        id: "admission-chioma",
        status: AdmissionStatus.APPROVED,
        appliedAt: new Date("2025-08-15T09:00:00.000Z"),
        decidedAt: new Date("2025-08-28T11:00:00.000Z"),
        notes: "Excellent interview performance",
      },
    },
    {
      email: "david.mensah@student.olive.school",
      firstName: "David",
      lastName: "Mensah",
      studentNumber: "STU-2025-005",
      studentStatus: StudentStatus.PROSPECT,
      gender: Gender.MALE,
      gradeLevel: "Year 9",
      primaryLanguage: "English",
      dateOfBirth: new Date("2010-12-03T00:00:00.000Z"),
      additionalSupportNotes: "Dyslexia - requires extra time for reading tasks",
      address: {
        line1: "22 Independence Avenue",
        city: "Accra",
        state: "Greater Accra",
      ...
      guardians: [
        {
          id: "guardian-david-mensah",
          firstName: "Kwame",
          lastName: "Mensah",
          email: "david.dad@example.com",
          phone: "+233240000001",
          addressLine1: "22 Independence Avenue",
          city: "Accra",
          state: "Greater Accra",
          postalCode: "GA-039-5028",
          country: "GH",
        ...
        {
          id: "guardian-david-mensah-mother",
          firstName: "Ama",
          lastName: "Mensah",
          email: "david.mum@example.com",
          phone: "+233240000002",
          addressLine1: "22 Independence Avenue",
          city: "Accra",
          state: "Greater Accra",
      ...
      admission: {
        id: "admission-david",
        status: AdmissionStatus.PENDING,
        appliedAt: new Date("2025-09-30T10:00:00.000Z"),
        decidedAt: null,
        notes: "Awaiting placement test results",
      },
    },
  ];
